...
public class student {
	    ...
	    public static void main(String[] args) {
	        ...
	        student s1 = new student("santhosh", 24, 'A','M', 97,99,99);
	        student s2 = new student("kumar", 29, 'B','M', 77,56,65);
	        student s3 = new student("raj", 21, 'A','M', 50,89,66);
	        student s4 = new student("siva", 24, 'B','M', 79,98,87);
